-- |This module provides the types necessary to represent unified
-- diffs and associated convenience functions.
...
data ChangeType = FileAdded | FileDeleted | FileRenamed | FileModified
                deriving (Eq, Show)
